...
// SET THESE TO FALSE BEFORE ROLLING OUT IN PRODUCTION
...
void setup() {
  ...
  attachInterrupt(digitalPinToInterrupt(encoderPinA), counter, CHANGE);
  attachInterrupt(digitalPinToInterrupt(encoderPinB), counter, CHANGE);	
